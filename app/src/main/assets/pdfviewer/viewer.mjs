...
const defaultOptions = {
  ...
  standardFontDataUrl: {
    value: "file:///android_asset/pdfviewer/standard_fonts/",
    kind: OptionKind.API
  },
  verbosity: {
    value: 1,
  ...
  workerSrc: {
    value: "file:///android_asset/pdfviewer/js/pdf.worker.mjs",
    kind: OptionKind.WORKER
  }
};
{
...
}
{
  defaultOptions.defaultUrl = {
    value: "file:///android_asset/pdf/samples.pdf",
    kind: OptionKind.VIEWER
  };
  ...
  defaultOptions.sandboxBundleSrc = {
    value: "file:///android_asset/pdfviewer/js/pdf.sandbox.mjs",
    kind: OptionKind.VIEWER
  };
}
